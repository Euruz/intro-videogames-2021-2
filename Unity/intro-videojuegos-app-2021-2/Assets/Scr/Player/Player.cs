...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //New vector to compare if the user is moving
        Vector2 ceros = new Vector2(0,0);

        //If user is moving player rotate to the movement direction
        if(_movementInput != ceros){
