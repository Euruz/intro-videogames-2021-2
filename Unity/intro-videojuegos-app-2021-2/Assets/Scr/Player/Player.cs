...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //If there is no input the vector becomes (0,0,0), in that case, the lookrotation needs to remain the same.
        //Avoids the targetRotation to become (0,0,0), in which case will return to the starting direction
        ...
        //keep looking to last direction
