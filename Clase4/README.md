...
- Repuesta: se observa que al cambiar CharacterControllerMovement por PlayerCharMovementController el personaje flota y tiene un movimiento mas fluido a la hora de subir las plataformas, ya que no se choca con estas, si no que las sobrepasa facilmente, mientras que en el primer caso solo se pueden subir si se suber en diagonal, y en ambas cuando el player se sale de la plataforma se quedan flotando y caen posteriormente
**Reto (Opcional)**
