...
- Note las diferencias entre trabajar con `Rigidbody` y `CharacterController`. Por ejemplo: que pasa con las pequeñas plataformas amarillas que hay en la escena? Como interactuan? Que pasa cuando el Player sale de las plataformas?
  ...
  SE DA UNA SENSACIÓN DE QUE EL PLAYER ADQUIERE UNA PEQUEÑA ALTURA QUE LO HACE FLOTAR
  HACIENDO QUE PUEDA SUBIR MÁS FÁCIL A LAS PLATAFORMAS Y A LA PELOTA, ADEMÁS LA CAIDA 
  O GRAVEDAD ES MAYOR Y MÁS NATURAL CUANDO EL PLAYER BAJA DE LAS MISMAS
